...
//		supplier.setSuppl_no("SPPL20001");
//		supplier.setSuppl_name("공급사테스트");
//		supplier.setCeo_name("테스터");
//		supplier.setCategory("직영점");
...
//	}
	...
	public void insertProposalTest() {
	    ...
	    // 공급사 정보 설정
	    supplier.setSuppl_no("SPPL10843"); // 실제 공급사의 고유 번호를 설정해야 함
	    proposal.setSupplier(supplier);

	    // 부품 정보 설정
	    component.setCompo_no("CPNT10057"); // 실제 부품의 고유 번호를 설정해야 함
