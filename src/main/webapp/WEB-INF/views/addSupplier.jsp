              ...
              <div class="addSupplierCard card theme-wizard mb-5 min-vh-75" data-theme-wizard="data-theme-wizard">
                ...
                <div class="card-header bg-100 pt-3 pb-2 border-bottom-0">
                  <ul class="nav justify-content-between nav-wizard" role="tablist">
                    <li class="nav-item" role="presentation"><a class="addSupplierCardHead fw-semi-bold nav-link active" href="#bootstrap-wizard-validation-tab1" data-bs-toggle="tab" data-wizard-step="1" aria-selected="true" role="tab">
                    ...
                    <li class="nav-item" role="presentation"><a class="addSupplierCardHead fw-semi-bold nav-link" href="#bootstrap-wizard-validation-tab2" data-bs-toggle="tab" data-wizard-step="2" aria-selected="false" tabindex="-1" role="tab">
                    ...
                    <li class="nav-item" role="presentation"><a class="addSupplierCardHead fw-semi-bold nav-link" href="#bootstrap-wizard-validation-tab3" data-bs-toggle="tab" data-wizard-step="3" aria-selected="false" tabindex="-1" role="tab">
                    ...
                    <li class="nav-item" role="presentation"><a class="addSupplierCardHead fw-semi-bold nav-link" href="#bootstrap-wizard-validation-tab4" data-bs-toggle="tab" data-wizard-step="4" aria-selected="false" tabindex="-1" role="tab">
                    ...
                    <div class="tab-pane" role="tabpanel" aria-labelledby="bootstrap-wizard-validation-tab2" id="bootstrap-wizard-validation-tab2">
                      <form class="needs-validation" id="wizardValidationForm2" novalidate="novalidate" data-wizard-form="2">
                        ...
                        <div class="mb-2">
                          ...
                          <input class="form-control" type="text" name="supplierName" placeholder="Supplier Name" id="suplierName-addSupplier" required="required">
                          <div class="invalid-feedback">공급사명은 필수로 입력하셔야 합니다.</div>
                        </div>

                        <div class="mb-2">
                          <label class="form-label" for="ceoName-addSupplier">대표자명</label>
                          <input class="form-control" type="text" name="ceoName" placeholder="CEO Name" id="ceoName-addSupplier" required="required">
                          <div class="invalid-feedback">This field is required.</div>
                        </div>

                        <div class="mb-2">
                          <label class="form-label" for="brNumber-addSupplier">사업자번호</label>
                          <input class="form-control" type="text" name="suppliername" placeholder="Business Registration Number" id="brNumber-addSupplier" required="required">
                          <div class="invalid-feedback">This field is required.</div>
                        </div>

                        <div class="mb-2">
                          <label class="form-label" for="phNumber-addSupplier">대표번호</label>
                          <input class="form-control" type="text" name="phone" placeholder="Phone Number" id="phNumber-addSupplier" required="required">
                          <div class="invalid-feedback">This field is required.</div>
                        </div>
                        <div class="mb-2">
                          <label class="form-label" for="address-addSupplier">주소</label>
                          <textarea class="form-control" rows="4" id="address-addSupplier" required="required"></textarea>
                          <div class="invalid-feedback">This field is required.</div>
                        </div>
                      </form>
                    </div>
                      ...
                      <form class="mb-2 needs-validation" id="wizardValidationForm3" novalidate="novalidate" data-wizard-form="3">
                        <div class="row gx-3 gy-2">
                          ...
                          <div class="col-6">
                            ...
                            <input class="form-control" placeholder="Quantity of component(ex. kg, t, ml, pieces)" name="cardName" type="text" id="quantity-addSupplier" required="required">
                            <div class="invalid-feedback">This field is required.</div>
                          </div>
                          <div class="col-6">
                            <label class="form-label" for="defectiveRate-addSupplier">불량률</label>
                            <input class="form-control" placeholder="Defective rate of component" name="zipCode" type="text" id="defectiveRate-addSupplier" required="required">
                            <div class="invalid-feedback">This field is required.</div>
                          </div>
                          <div class="col-6">
                      ...
                      <div class="row flex-center pb-8 pt-4 gx-3 gy-4 mt-10 min-vh-50">
                        ...
                        <div class="col-12 col-sm-auto">
                          <div class="text-center text-sm-start">
                            ...
                            <p class="text-1100 fs--1">공급사 자동 저장이 완료되었습니다.<br>해당 공급사를 등록하시려면 오른쪽 하단의 등록 버튼을 입력하세요.</p><a class="btn btn-outline-primary px-6" href="/">메인 화면으로 돌아가기</a>
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div class="mb-3 row">
                    ...
                    <div class="col-sm-9">
                      <input class="form-control-plaintext outline-none text-center fs-sm--1" id="prePrice" type="number" readonly="" value=""/>
                    </div>
                  ...
                  <div class="card-footer border-top-1" data-wizard-footer="data-wizard-footer">
                    <div class="d-flex pager wizard list-inline ">
                      <button id="submitSupplierBtn" class="btn btn-primary w-100" type="submit" data-wizard-prev-btn="data-wizard-prev-btn" disabled="true">공급사 등록</button>
                    </div>
                  </div>
    ...
    <script>
      $(document).ready(function() {
        ...
        btnNextAdd.click(function(){
          ...
          $("#prePrice").val($("#price-addSupplier").val());
